...
const PriceTag = ({
  ...
  return (
    <div className="border rounded-full px-3 py-2 flex items-center gap-3  md:justify-between border-green-500 absolute bottom-0   -translate-y-5 translate-x-5 bg-green-900 bg-opacity-80">
